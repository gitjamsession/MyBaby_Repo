 ...
 */
public class BabyVaccineContentProvider extends ContentProvider {



    public static final String KEY_ID = "_id";
    public static final String KEY_VACCINE_NAME = "vaccine_name";
    public static final String KEY_VACCINE_DATE = "vaccine_date";


    private static class MySQLiteOpenHelper extends SQLiteOpenHelper {


        private static final String DATABASE_NAME = "VaccineDatabase.db";
        private static final int DATABASE_VERSION = 1;
        private static final String DATABASE_TABLE = "VaccineItemTable";
...
// Create a new one.
    ...
    public static final Uri CONTENT_URI =
            Uri.parse("content://com.beatitudes.myBaby.Baby.BabyVaccineContentProvider");
...
//represents a single row.
    static {
        ...
        uriMatcher.addURI("com.beatitudes.mybaby.Baby.BabyVaccineContentProvider", "VaccineItems", ALLROWS);
        uriMatcher.addURI("com.beatitudes.mybaby.Baby.BabyVaccineContentProvider", "VaccineItems/#", SINGLE_ROW);
    }
    @Override
...
// for a Content Provider URI
        switch (uriMatcher.match(uri)) {
            case ALLROWS: return "vnd.android.cursor.dir/vnd.MyBaby.VaccineItems";
            case SINGLE_ROW: return "vnd.android.cursor.item/vnd.MyBaby.VaccineItems";
